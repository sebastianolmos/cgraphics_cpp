...
int main()
{
    ...
    // ------------------------------------
    Shader basicShader(getPath("source/shaders/basicShader.vs").string().c_str(), 
                       getPath("source/shaders/basicShader.fs").string().c_str()); // you can name your shader files however you like
