...
int main()
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        depthMappingShader.setMat4("lightSpaceMat", lightSpaceMatrix);
        ...
        if (currentDepthMap != EDepthMap::None) {
            ...
            depthDebugShader.setFloat("nearPlane", nearPlane);
            depthDebugShader.setFloat("farPlane", farPlane);
            glActiveTexture(GL_TEXTURE0);
            glBindTexture(GL_TEXTURE_2D, depthMap);
